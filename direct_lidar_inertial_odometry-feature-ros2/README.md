...
## Please call the follow service to save the map
- ros2 service call /save_pcd direct_lidar_inertial_odometry/srv/SavePCD "{leaf_size: 0.1, save_path: '/xxx/xxxx/xxxx'}"
- leaf_size is the resolution of the map
