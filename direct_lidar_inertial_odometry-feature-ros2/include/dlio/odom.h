...
private:
  ...
  void RemoveGround(pcl::PointCloud<PointType>::Ptr, float z_min);
  void SavePoseAndFrame(pcl::PointCloud<PointType>::ConstPtr published_cloud, Eigen::Matrix4f T_cloud);
